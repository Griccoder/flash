...
#CALL_ADDRESS
CALL_ADDRESS = CADD = '31010301'

#HASH_CHECK
HASH_CHECK = HC = '31010212'
...
ERROR_DIC={
    "10":"GeneralReject = 0x10",
    "11":"ServiceNotSupported = 0x11",
    "12":"SubFunctionNotSupported = 0x12",
    "13":"IncorrectMessageLegthOrInvalidFormat = 0x13",
    "14":"ResponseTooLong = 0x14",
    "21":"BusyRepeatRequest = 0x21",
    "22":"ConditionsNotCorrect = 0x22",
    "24":"RequestSequenceError = 0x24",
    "25":"NoResponseFromSubnetComponent = 0x25",
    "26":"FailurePreventsExecutionOfRequestedAction = 0x26",
    "31":"RequestOutOfRange = 0x31",
    "33":"SecurityAccessDenied = 0x33",
    "35":"InvalidKey = 0x35",
    "36":"ExceedNumberOfAttempts = 0x36",
    "37":"RequiredTimeDelayNotExpired = 0x37",
    "70":"UploadDownloadNotAccepted = 0x70",
    "71":"TransferDataSuspended = 0x71",
    "72":"GeneralProgrammingFailure = 0x72",
    "73":"WrongBlockSequenceCounter = 0x73",
    "78":"RequestCorrectlyReceived_ResponsePending = 0x78",
    "7E":"SubFunctionNotSupportedInActiveSession = 0x7E",
    "7F":"ServiceNotSupportedInActiveSession = 0x7F",
    "81":"RpmTooHigh = 0x81",
    "82":"RpmTooLow = 0x82",
    "83":"EngineIsRunning = 0x83",
    "84":"EngineIsNotRunning = 0x84",
    "85":"EngineRunTimeTooLow = 0x85",
    "86":"TemperatureTooHigh = 0x86",
    "87":"TemperatureTooLow = 0x87",
    "88":"VehicleSpeedTooHigh = 0x88",
    "89":"VehicleSpeedTooLow = 0x89",
    "8A":"ThrottlePedalTooHigh = 0x8A",
    "8B":"ThrottlePedalTooLow = 0x8B",
    "8C":"TransmissionRangeNotInNeutral = 0x8C",
    "8D":"TransmissionRangeNotInGear = 0x8D",
    "8E":"ISOSAEReserved = 0x8E",
    "8F":"BrakeSwitchNotClosed = 0x8F",
    "90":"ShifterLeverNotInPark = 0x90",
    "91":"TorqueConverterClutchLocked = 0x91",
    "92":"VoltageTooHigh = 0x92",
    "93":"VoltageTooLow = 0x93",
    "38":"GeneralSecurityViolation = 0x38 + 0",
    "39":"SecuredModeRequested= 0x38 + 1",
    "40":"InsufficientProtection= 0x38 + 2",
    "41":"TerminationWithSignatureRequested= 0x38 + 3",
    "42":"AccessDenied= 0x38 + 4",
    "43":"VersionNotSupported= 0x38 + 5",
    "44":"SecuredLinkNotSupported= 0x38 + 6",
    "45":"CertificateNotAvailable= 0x38 + 7",
    "46":"AuditTrailInformationNotAvailable= 0x38 + 8"
}
